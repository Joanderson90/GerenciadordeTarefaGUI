...
public class User implements UserI {
	...
	/**
	 * Método para inicializar o projeto com alguns projetos e tarefas para
	 * facilitar os testes Para funcionar é necessário descomentar a única linha de
	 * codigo do contrutor vazio desta classe
	 */
	 ...
	 * @return boolean true se todas as tarefas estão concluídas, ou false caso
	 *         contrário.
	 */
	...
	public Projeto buscarProjetoQuePossuiTarefa(Tarefa tarefaTarget) throws ObjetoInexistenteException {
		...
		while (itProjetosCadastrados.hasNext()) {
			...
			while (itTarefasCadastradas.hasNext()) {
				...
				if (tarefaCadastrada == tarefaTarget)
	...
	public Tarefa buscarTarefaPorTitulo(String tituloTarget) throws ObjetoInexistenteException {
		...
		while (itProjetosCadastrados.hasNext()) {
			...
			while (itTarefasCadastradas.hasNext()) {
				...
				if (tituloTarefaCadastrada == tituloTarget)
